...
let product = [
  {
    id: "0",
    image: "./images/01.png",
    title: " Oleves Watch 01",
    price: 300,
  },
  {
    id: "1",
    image: "./images/02.png",
    title: "Oleves Watch 02",
    price: 200,
    catagory: "sports",
  },
...
function showCartData() {
  ...
  document.getElementById("pricebox").innerHTML=totalPrice;
}

function addCartData(items) {
  cartData.push(items);
...
for (let pro in product) {
  ...
  data += `
    <div class="text-center mx-auto">
         ...
         <div> <button id="" onclick=addCartData(${pro}) class="bg-[#f59e0b] w-[90%] rounded-md text-blue-500 font-bold py-1 hover:bg-green-500 hover:text-red-700">Add to cart</button></div>
        </div>
    </div> `;
